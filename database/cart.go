...
func BuyItemFromCart(ctx context.Context, prodCollection, userCollection *mongo.Collection, productID primitive.ObjectID, userID string) error {
	...
	_, err = userCollection.UpdateOne(ctx, filtered, update3)
	if err != nil {
